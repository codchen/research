...
# symbol can be found at https://blog.quandl.com/api-for-currency-data
...
process('FRED/DEXUSUK')
process('FRED/DEXCAUS')
process('FRED/DEXCHUS')
process('FRED/DEXUSEU')
process('FRED/DEXJPUS')
process('FRED/DEXUSNZ')
process('FRED/DEXSZUS')